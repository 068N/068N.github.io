...
- 综合练习：达内员工管理系统
   ...
   7)班主任，继承雇员超类: 重写1个抽象方法
   ```



```java
package OOP.day03.tedu;
//7)班主任类，继承雇员超类: 重写1个抽象方法

public class ClassroomTeacher extends Employee {
    @Override
...
interface CorporateConsultant{
    void solvingBusinessProblems();
    void trainingEmployees();
}
...
public class DirectorOfTeachingAndResearch extends Employee implements CorporateConsultant, TechnicalAuthors {
    @Override
    public void finishWork() {
    }

    @Override
    public void solvingBusinessProblems() {
    }

    @Override
    public void trainingEmployees() {
    }
...
public class Lecturer extends Employee implements CorporateConsultant, TechnicalAuthors {
    @Override
    public void finishWork() {
    }
...
public class ProjectManager extends Employee implements TechnicalAuthors {
    @Override
    public void finishWork() {
    }
